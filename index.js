  ...
  res.json({
    ...
    endpoints: {
      ...
      restoreOrganiser: {
        ...
        listActivity: "GET /api/restore-organiser/activity (auth, Premium)",
        logActivity: "POST /api/restore-organiser/activity (auth, Premium)",
      },
      admin: {
        ...
        backupGuardOverview: "GET /api/admin/backup-guard/overview",
      },
    },
  });
});
